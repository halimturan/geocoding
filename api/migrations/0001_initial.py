# Generated by Django 3.2.10 on 2022-01-12 21:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('kategori_id', models.SmallIntegerField(blank=True, null=True, verbose_name='Kategori ID')),
                ('alt_kategori_id', models.SmallIntegerField(blank=True, null=True, verbose_name='Alt Kategori ID')),
                ('ad', models.CharField(max_length=250, verbose_name='İsim')),
                ('ilce_ad', models.CharField(max_length=50, verbose_name='İsim')),
                ('mahalle_ad', models.CharField(max_length=50, verbose_name='Mahalle İsim')),
                ('kategori', models.CharField(blank=True, max_length=50, null=True, verbose_name='Kategori')),
                ('alt_kategori', models.CharField(blank=True, max_length=50, null=True, verbose_name='Alt Kategori')),
